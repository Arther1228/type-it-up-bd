...
public class HDHbaseAPI {
    ...
    public static Connection initHbase() throws IOException {
        ...
        configuration.set("hbase.zookeeper.quorum", "34.8.8.4");
        configuration.set("hbase.zookeeper.property.clientPort", "24002");
        configuration.set("hbase.master", "34.8.8.6:21300");
